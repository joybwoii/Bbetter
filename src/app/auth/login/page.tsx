...
import { loginUser, demoLogin } from '@/lib/actions/auth';
  ...
  const handleDemoAdminLogin = async () => {
    ...
    try {
      ...
      if (res.success) {
        ...
        setError('Failed to log in as demo admin');
      }
    } catch (err: any) {
    ...
    <div className={styles.authContainer}>
      <div className={styles.authCard}>
        ...
        <button 
          ...
          style={{ borderColor: 'var(--primary)', color: 'var(--primary)', marginTop: '0.25rem' }} 
          disabled={loading}
        >
          🔐 Login as Demo Admin (Local Testing)
        </button>
